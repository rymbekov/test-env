...
const pathConfig = {
  AppRouter: path.join(__dirname, 'static/assets/js/router/router.single'),
...
config.entry = ['./static/assets/js/index.single.js'];
...
config.plugins = [
  ...
  new CopyWebpackPlugin([
    { from: 'templates/single.login.html', to: path.join(themeFolder, 'templ', 'login.ejs') },
  ...
  new htmlWebpackPlugin({
    template: path.join(__dirname, 'templates/single.index.html'),
    path: buildPath,
